...
//Unit test for cardEffect(village) found in dominion.c
int main()
{
  struct gameState G;
  ...
  printf("\n==================================================\n");
  printf("CARD TEST 3: cardEffect(village)\n");
  printf("==================================================\n\n"); 
  ...
  printf("\n-------------------- TEST 1 --------------------\n");
  printf("Activating village card effect.\n");
  ...
  printf("Asserting: G.numActions == GCopy.numActions+2\n");
  ...
  if(asserterrors){
    printf("CARD TEST 3 FAILED!!! (%d assertion errors)\n", asserterrors);
  }
  else {
