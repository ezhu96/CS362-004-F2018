...
//Unit test for cardEffect(great hall) found in dominion.c
int main()
{
  struct gameState G;
  ...
  printf("\n==================================================\n");
  printf("CARD TEST 4: cardEffect(great hall)\n");
  printf("==================================================\n\n"); 
  ...
  printf("\n-------------------- TEST 1 --------------------\n");
  printf("Activating great hall card effect.\n");
  ...
  printf("Asserting: G.numActions == GCopy.numActions+1\n");
  asserttrue(G.numActions == GCopy.numActions+1);
  ...
  printf("Asserting: G.handCount[playerOne] == GCopy.handCount[playerOne]\n");
  asserttrue(G.handCount[playerOne] == GCopy.handCount[playerOne]);
  for(i=0; i<GCopy.deckCount[playerOne]-1; i++){
    printf("Asserting: G.deck[playerOne][i] == GCopy.deck[playerOne][i])\n");
    asserttrue(G.deck[playerOne][i] == GCopy.deck[playerOne][i]);
  }
  printf("Asserting: G.deckCount[playerOne] == GCopy.deckCount[playerOne]-1)\n");
  asserttrue(G.deckCount[playerOne] == GCopy.deckCount[playerOne]-1);
  ...
  if(asserterrors){
    printf("CARD TEST 4 FAILED!!! (%d assertion errors)\n", asserterrors);
  }
  else {
